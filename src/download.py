...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--filepath", type=str, default="", help="dst destination file path"
    )
    ...
    if args.verbose:
        ...
        print(args.protocol)
client = client(
    args.addr, args.port, args.filepath, args.filename, args.verbose, args.quiet
)
client.download()
print("File has been downloaded succesfully at {args.filepath}")
client.close()
